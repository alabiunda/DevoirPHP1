<?php
    ...
    if(isset($_GET['search'])) {
        ...
        try {
            $statement->execute([htmlspecialchars($_GET['search'])]);
...
<body>
    <header>
        <h1>Super Safe Shop 3.0</h1>
        <section class="search">
            <form action="prepared_and_escape.php" method="get" autocomplete="none">
    ...
    <main>
        ...
        <section class="results">
            ...
            <?php elseif ($has_search): ?>
                <span class="warning">Aucun résultat pour votre recherche "<?= htmlspecialchars($_GET['search']) ?>"</span>
            <?php endif; ?>
        </section>
    </main>
</body>
